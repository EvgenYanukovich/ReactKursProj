			...
			<div className="container mx-auto px-4 py-8">
				<div className="grid grid-cols-1 md:grid-cols-4 gap-8">
					...
					<div>
						...
						<ul className="space-y-2">
							<li>
								<Link to="/catalog/dogs" className="text-gray-300 hover:text-white">
									Товары для собак
								</Link>
							</li>
							<li>
								<Link to="/catalog/cats" className="text-gray-300 hover:text-white">
									Товары для кошек
								</Link>
							</li>
							<li>
						...
						<ul className="space-y-2">
							<li className="flex items-start">
								<svg
									...
									className="h-5 w-5 mr-2 mt-1 text-orange-500"
									viewBox="0 0 20 20"
									fill="currentColor"
								>
									<path
							...
							<li className="flex items-center">
								...
								<span>info@pawsandclaws.ru</span>
							</li>
						</ul>
				...
				<div className="mt-8 pt-6 border-t border-gray-700 text-center text-sm text-gray-400">
					© 2025 Paws&Claws. Все права защищены.
				</div>
			</div>
		</footer>
	);

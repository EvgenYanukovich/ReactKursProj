            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                    <div className="bg-white rounded-lg shadow-md p-6">
                        ...
                        <div className="mt-8">
                            <h3 className="font-medium text-gray-800 mb-4">Мы в социальных сетях</h3>
                            <div className="flex space-x-4">
                                <a href="#" className="bg-gray-100 p-2 rounded-full text-gray-600 hover:bg-orange-100 hover:text-orange-500">
                    ...
                    <div className="mt-8 bg-white rounded-lg shadow-md p-6">
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <p className="text-gray-600">Добавьте товары в корзину, перейдите к оформлению и следуйте инструкциям.</p>
                            </div>
                            
                            <div>
                                <h3 className="font-medium text-gray-800">Какие способы оплаты доступны?</h3>
                                <p className="text-gray-600">Мы принимаем оплату картой, наличными при получении и электронными платежами.</p>
                            </div>
                            
                            <div>
                                <h3 className="font-medium text-gray-800">Сроки доставки?</h3>
                                <p className="text-gray-600">Доставка по Москве осуществляется в течение 1-2 дней, по России 3-7 дней.</p>
                            </div>
                        </div>
                    </div>
                </div>

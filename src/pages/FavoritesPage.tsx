    ...
    <div className="container mx-auto px-4 py-8 bg-[var(--bg-body)]">
      ...
      {favorites.length === 0 ? (
        <div className="bg-[var(--bg-primary)] p-6 rounded-lg shadow-sm border border-[var(--border-color)] text-center">
          <p className="text-[var(--text-secondary)] mb-4">У вас пока нет избранных товаров</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {favorites.map((product) => (
            <div key={product.id} className="bg-[var(--bg-primary)] rounded-lg shadow-sm border border-[var(--border-color)] overflow-hidden">
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute top-2 right-2 bg-[var(--bg-primary)] rounded-full p-1 shadow-md hover:bg-[var(--bg-hover)]"
              ...
              <div className="p-4">
                <Link to={`/product/${product.id}`} className="block">
                  <h3 className="text-lg font-medium text-[var(--text-primary)] hover:text-[var(--accent-color)] mb-2">
                    {product.name}
                  </h3>
                </Link>
                ...
                <div className="flex items-center mb-2">
                  ...
                  <span className="text-sm text-[var(--text-secondary)]">{product.petType}</span>
                </div>
                ...
                <div className="flex items-center justify-between mt-4">
                  ...
                  <button
                    ...
                    className="bg-[var(--accent-color)] hover:bg-[var(--accent-hover)] text-white py-1 px-3 rounded-md flex items-center"
                  >
